...
SECRET_KEY = 'django-insecure-4q-qs3o5a(ch5bkhv9e%*&**r*vrlw@drlm4(nzx7_x61t9gxt'
...
ROOT_URLCONF = 'togoskills_backend.urls'
...
WSGI_APPLICATION = 'togoskills_backend.wsgi.application'
